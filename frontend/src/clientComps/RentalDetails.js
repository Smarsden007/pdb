    ...
    <div>
      <div className="grid grid-cols-1 lg:grid-cols-2 lg:grid-rows-2 gap-4">
        ...
        <div className="col-start-1 lg:col-start-1 lg:row-start-2 flex justify-center items-center ">
            <div
              href="#"
              class="flex flex-col bg-white  border rounded-lg shadow-lg md:flex-row md:max-w-xl hover:scale-105"
            >
              <img
                alt="example"
                src={Castle}
              ...
              />
              <div class="flex flex-col justify-between ml-4 mr-4 leading-normal bg-white">
                <h5 class="mb-2 p-1 text-2xl font-bold tracking-tight text-gray-900">
                  Classic Castle
                </h5>
                <p class=" text-[.75rem] text-gray-700 dark:text-gray-400">
                  13x13
                    ...
                    items={[
                      {
                        ...
                        children: (
                          <div className="grid grid-cols-2 gap-4 h-auto">
                            <ul>
                              <li className="border border-black rounded-full w-auto h-7 text-center m-1 p-1">
                                Generator
                              </li>
                              <li className="border border-black rounded-full w-auto h-7 text-center m-1 p-1">
                                13x13 Tarp
